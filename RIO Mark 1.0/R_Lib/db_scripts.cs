    ...
    public class db_scripts
    {
        ...
        public void TblSysCommands_Inserts()
        {
            sysCommand[] sysCommands = {
                ...
                new sysCommand(3, "rio hide", "Default", "R_UI_onSystemTray"),
                new sysCommand(3, "hide rio", "Default", "R_UI_onSystemTray"),
                new sysCommand(3, "hide", "Default", "R_UI_onSystemTray"),
                new sysCommand(3, "to the system tray", "Default", "R_UI_onSystemTray"),
