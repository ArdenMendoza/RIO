...
namespace RIO
{
    public class UICommands
    {
        ...
        public Form _UI = new Form();

        public UICommands(Form f)
        {
            _UI = f;
        }
        ...
        {
            UI.notifIcon.Visible = true;
            UI.notifIcon.BalloonTipText = "I'll be right here if you need anything else sir";
            UI.notifIcon.BalloonTipTitle = Application.ProductName;
            UI.notifIcon.BalloonTipIcon = ToolTipIcon.Info;
            UI.notifIcon.Text = "RIO hidden from view";
            UI.notifIcon.ShowBalloonTip(3000);

            UI.ShowInTaskbar = false;
            UI.Hide();
            R_Speech.SpeakAsync(UI.notifIcon.BalloonTipText);
        }
        ...
        public void UI_centerAlignIcon()
        {
            ...
            int myHorCenter = UI.img_rio.Width / 2;
            int myVerCenter = UI.img_rio.Height / 2;

            UI.Left = (scrnWidth / 2) - myHorCenter;
            UI.Top = (scrnHeight / 2) - myVerCenter;
        ...
        public void volumeUp()
        {
            ...
            for (int i = 0; i < vol; i++)
            {
                SendMessageW(UI.Handle, WM_APPCOMMAND, UI.Handle, (IntPtr)APPCOMMAND_VOLUME_UP);
            }
        ...
        public void volumeDown()
        {
            ...
            for (int i = 0; i < vol; i++)
            {
                SendMessageW(UI.Handle, WM_APPCOMMAND, UI.Handle, (IntPtr)APPCOMMAND_VOLUME_DOWN);
            }
        ...
        public void mute()
        {
            SendMessageW(UI.Handle, WM_APPCOMMAND, UI.Handle, (IntPtr)APPCOMMAND_VOLUME_MUTE);
        }
        #endregion 
        ...
        public void ws_get_weather()
        {
            ...
            UI.rt_Convo.AppendText(weather.getWeather());
        ...
        public void get_AtomicNumber() { UI.rt_Convo.AppendText(PeriodicTable.get_AtomicNumber("Tungsten")); }
